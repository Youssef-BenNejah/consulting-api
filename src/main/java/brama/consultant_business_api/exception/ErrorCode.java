...
public enum ErrorCode {
    ...
    OTP_INVALID("OTP_INVALID", "Invalid OTP", BAD_REQUEST),
    OTP_EXPIRED("OTP_EXPIRED", "OTP has expired", BAD_REQUEST),
    OTP_ALREADY_USED("OTP_ALREADY_USED", "OTP has already been used", BAD_REQUEST),
    OTP_NOT_FOUND("OTP_NOT_FOUND", "OTP not found", NOT_FOUND),
    BAD_CREDENTIALS("BAD_CREDENTIALS", "Username and / or password is incorrect", UNAUTHORIZED),
    INVALID_REQUEST("INVALID_REQUEST", "Invalid request: %s", BAD_REQUEST),
    INVALID_CURRENCY("INVALID_CURRENCY", "Unsupported currency: %s", BAD_REQUEST),
    INVALID_DATE_RANGE("INVALID_DATE_RANGE", "Invalid date range: %s", BAD_REQUEST),
